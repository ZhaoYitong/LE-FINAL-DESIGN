# Generated by Django 2.2 on 2019-05-26 11:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ColNo', models.CharField(blank=True, max_length=50, null=True, verbose_name='列号')),
                ('DeckCagSig', models.CharField(blank=True, max_length=50, null=True, verbose_name='甲板or舱内')),
                ...
                ('GForce', models.CharField(blank=True, max_length=1000, null=True, verbose_name='货特要求')),
                ...
                ('YardCel', models.CharField(blank=True, max_length=50, null=True, verbose_name='堆场箱位')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('UnloadPort', models.CharField(blank=True, max_length=50, null=True, verbose_name='卸货港')),
                ('DesPort', models.CharField(blank=True, max_length=50, null=True, verbose_name='目的港')),
                ('StrPickAwayCtn', models.CharField(blank=True, max_length=50, null=True, verbose_name='直提箱')),
                ('CtnOpeSta', models.CharField(blank=True, max_length=50, null=True, verbose_name='箱作业状态')),
