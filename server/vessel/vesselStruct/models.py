...
class vesselVoyInfo(models.Model):
    ...
    TaskFiniSig = models.CharField(null=True, blank=True, max_length=10, choices=TASK_FIN_SIG_CHOICES, verbose_name='作业完成情况', default='1')
    UnBSta = models.CharField(null=True, blank=True, max_length=10, choices=UNB_STATUS_CHOICES, verbose_name='离泊情况', default='1')
...
class vesBayStruct(models.Model):
    ...
    BayCom = models.CharField(null=True, blank=True, max_length=10, choices=BAY_COM_CHOICES, default='0', verbose_name='贝组')
    ...
    MidBayDeaWit = models.CharField(null=True, blank=True,  max_length=10, choices=MID_BAY_DEAL_WIT_CHOICES, verbose_name='中间贝处理')
...
class qcDisPlanOut(models.Model):
    ...
    BayInnTaskCluNo = models.CharField(null=True, blank=True, max_length=1000, verbose_name='作业贝位内任务簇编号(贝位作业的再划分)')
    ...
    PreBayInnTaskCluNo = models.CharField(null=True, blank=True, max_length=1000, verbose_name='紧前作业贝位内任务簇编号')
    PreTaskCluKind = models.CharField(null=True, blank=True, max_length=3, choices=PRE_TASK_CLU_KIND_CHOICES, verbose_name='作业紧前类别') # choices
